...
function spatialize_wsj0_mix(num_speakers,min_or_max,fs,start_ind,stop_ind,useparcluster_with_ind,generate_rirs)
    ...
    data_in_root  = '/Work18/2015/gemeng/data/wsj0-mix-mc/'; % directory of the original wsj0-mix data
    rir_root      = '/Work18/2015/gemeng/data/wsj0-mix-mc/'; % directory to write the generated RIRs into
    data_out_root = '/Work18/2015/gemeng/data/wsj0-mix-mc/'; % directory to write the spatialized mixtures into
